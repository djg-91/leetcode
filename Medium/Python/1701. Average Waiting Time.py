...
https://leetcode.com/problems/average-waiting-time
    ...
    preparing it once he is idle. The customer waits till the chef finishes preparing his order. 
    The chef does not prepare food for more than one customer at a time. The chef prepares food 
    for customers in the order they were given in the input.
    ...
    Example 2:
        ...
        Explanation:
            1) The first customer arrives at time 5, the chef takes his order and starts preparing 
               it immediately at time 5, and finishes at time 7, so the waiting time of 
               the first customer is 7 - 5 = 2.
            2) The second customer arrives at time 5, the chef takes his order and starts 
               preparing it at time 7, and finishes at time 11, so the waiting time of 
               the second customer is 11 - 5 = 6.
            ...
            4) The fourth customer arrives at time 20, the chef takes his order and starts 
               preparing it immediately at time 20, and finishes at time 21, so the waiting time of the 
...
class Solution:
    def averageWaitingTime(self, customers: List[List[int]]) -> float:
        ...
        for customer in customers:
            chef = chef if chef > customer[0] else customer[0]
            chef += customer[1]
            waiting.append(chef - customer[0])
